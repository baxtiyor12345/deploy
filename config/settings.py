...
SECRET_KEY = 'django-insecure-pl=d)!1ss^wrniu@(_(po4^(&*_wcpvcr4=j4ao(*rkj-c3-#^'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*', '209.38.193.115']
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 2,  # Har sahifada nechta element chiqadi
}
...
AUTH_USER_MODEL = 'training_center.User'
